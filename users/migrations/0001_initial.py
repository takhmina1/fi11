    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=19, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(19), django.core.validators.RegexValidator(message='Телефон должен быть в формате: +996999999900', regex='^\\+?1?\\d{11}$')], verbose_name='Телефон')),
